...
* `Two\_Wheeler\_Loan\_Analyzer.xlsx` — the workbook
...
* \*\*Also available on Kaggle:\*\*\[Two Wheeler Loan Analysis dataset]
(https://www.kaggle.com/datasets/anirudhreddy2703/two-wheeler-loan-analysis)
